      ...
      <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-10 px-8 py-12 text-gray-100">
        ...
        <section className="grid gap-6 border border-gray-800 bg-black/90 p-8 shadow-xl shadow-black/40 lg:grid-cols-2">
          <article className="flex flex-col gap-4">
            <h2 className="text-2xl font-semibold text-white">Explore the example</h2>
            <p className="text-gray-300">
              Try the{" "}
              <a className="font-medium text-gray-200 underline decoration-gray-500 hover:text-white" href="/api/time">
                /api/time
              </a>{" "}
              endpoint, POST to{" "}
              <code className="bg-gray-900 px-2 py-1 font-medium text-gray-200">
              ...
              , or visit the{" "}
              <a className="font-medium text-gray-200 underline decoration-gray-500 hover:text-white" href="/public/index.html">
                static asset
              </a>{" "}
              bundled by HyperBun.
            </p>
